function displayImages(dataset, original_image_size, zoom_scale, str_title, image_indices)
    pad = 1;
    ...
    for j = 1:display_rows
        for i = 1:display_cols
            ...
            comp = imresize(reshape(dataset(:,image_indices(index)), original_image_size), real_image_size);
            comp = normalize(comp);
